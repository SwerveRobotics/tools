...
namespace NativeUsbLib
    ...
    public static class UsbApi
        ...
        public struct SP_DEVICE_INTERFACE_DETAIL_DATA
            {
            public int cbSize;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = MAX_BUFFER_SIZE)] public string DevicePath;
            }
        ...
        public struct USB_HCD_DRIVERKEY_NAME
            ...
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = MAX_BUFFER_SIZE)] public string DriverKeyName;
            }
        ...
        public struct USB_ROOT_HUB_NAME
            {
            public int ActualLength;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = MAX_BUFFER_SIZE)] public string RootHubName;
            }
        ...
        public struct USB_NODE_CONNECTION_NAME
            ...
            public int ConnectionIndex;
            public int ActualLength;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = MAX_BUFFER_SIZE)] public string NodeName;
            }
